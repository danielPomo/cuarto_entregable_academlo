...
const ormErrorHandler = (error, req, res, next) => {
    if (error instanceof ConnectionAcquireTimeoutError || error instanceof ConnectionError || error instanceof ConnectionRefusedError || error instanceof ConnectionTimedOutError || error instanceof InvalidConnectionError){
